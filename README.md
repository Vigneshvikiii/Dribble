...
<body>
  ...
  <footer class="bg-black text-white text-center">
    <div class="container">
        <p>&copy; 2024 PharmaCompany. All rights reserved. BY VIGNESH S (212223230240)</p>
    </div>
</footer>
...
<body>
  ...
  <footer>
    <div class="container">
      <p>&copy; 2024 PharmaCompany. All rights reserved. BY VIGNESH (212223230240)</p>
    </div>
  </footer>
...
![image](https://github.com/user-attachments/assets/1fe13cac-49a0-4592-968a-97ea1e7dbcde)

![image](https://github.com/user-attachments/assets/c9c5b9d8-1890-48c9-9b36-eee2b12896fd)

![image](https://github.com/user-attachments/assets/8cde3f34-a5fe-4a44-9bc4-45c283b754c6)

![image](https://github.com/user-attachments/assets/68dc0895-83f3-4df2-a097-833dfc2fd2bf)
